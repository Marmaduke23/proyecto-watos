...
# ------------------ EJEMPLO ------------------
reference_hamburger = {
    "calories": 250, "totalfat": 9, "fatsaturated": 3.5,
    "fattrans": 0.5, "cholesterol": 25, "sodium": 520,
    "carbs": 31, "fiber": 2, "sugar": 6, "protein": 12
}

json_data, ttl_path = fetch_foods_with_ttl_and_json(reference_hamburger)
print(json_data)
print(f"TTL guardado en: {ttl_path}")
